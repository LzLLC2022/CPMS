    ...
    <div className="flex min-h-screen bg-white">
                ...
                <div>
                  ...
                  <div className="mt-2 flex rounded-md shadow-sm">
                    <input
                      ...
                      required
                      className="block w-full min-w-0 flex-1 rounded-none rounded-l-md border-0 py-1.5 px-3 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary-600 sm:text-sm sm:leading-6 outline-none"
                      placeholder="email"
                    />
                ...
                <div>
                  ...
                  <div className="mt-2">
                    <input
                      ...
                      required
                      className="block w-full rounded-md border-0 py-1.5 px-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary-600 sm:text-sm sm:leading-6 outline-none"
                    />
                  </div>
                </div>
      ...
      <div className="relative hidden w-0 flex-1 lg:block bg-primary-900">
        <div className="absolute inset-0 flex flex-col justify-center items-start px-20 xl:px-32 bg-gradient-to-br from-primary-900 to-primary-800 text-white">
          <h1 className="text-4xl font-extrabold mb-8 text-primary-50">
            Climate Technology Accelerator Fund
          </h1>
